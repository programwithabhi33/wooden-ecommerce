...
const addOrderItems = asyncHandler(async (req, res) => {
    ...
    } else if (!shippingAddress || !shippingAddress.address || !shippingAddress.city || !shippingAddress.postalCode || !shippingAddress.country || !shippingAddress.contactNumber) {
        res.status(400);
        throw new Error('Please provide a complete shipping address including contact number');
    } else {
